#ifndef __POPULATIONTRAINER_HPP__
#define __POPULATIONTRAINER_HPP__
/*!
 * \file PopulationTrainer.hpp
 * Header of the PopulationTrainer class.
 * \author Luc Mioulet
 */
 ...
 * Description
 */
class PopulationTrainer: public SupervisedTrainer {
private:
...
public:
	 ...
	 *
	 */
	PopulationTrainer(PBDNN& _population, RegressionDataset& _data, LearningParams& _params, RegressionDataset& _valid, Mask& _featureMask, Mask& _indexMask, std::ostream& _log);
