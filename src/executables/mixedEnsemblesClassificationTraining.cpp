...
int main(int argc, char* argv[]) {
  ...
  ClassDataset trainingClassDataset;
  ...
  ImageBackPropME trainer = ImageBackPropME(me,trainingDataset,trainingClassDataset,testDataset,testClassDataset,params,log);
  cout << "Training starting by a first check" <<endl;
